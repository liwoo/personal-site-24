...
graph TB
    ...
    B --> F[Model-Driven Apps<br/>No-code forms & views]
    B --> G[Canvas Apps<br/>Low-code drag & drop]
    B --> H[Code Apps<br/>Pro-code React/TypeScript]
...
graph LR
    ...
    D --> F[Strongly Typed Services]

    C --> G[Roles & Permissions]
    E --> H[Email & Workflows]

    I[Microsoft Handles] --> C
    I --> D
    I --> E
    I --> J[Deployment & Hosting]
    I --> K[Monitoring & Logs]

    style A fill:#61DAFB,stroke:#20232A
    style I fill:#FFB900,stroke:#D83B01
```
