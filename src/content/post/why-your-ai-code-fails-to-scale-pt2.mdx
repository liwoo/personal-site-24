...
excerpt: I shipped a fintech SaaS in 16 days. 38 commits, 304K lines, 24 entities. Seriously. Here's what that looks like in practice.
category: Tech
draft: false
tags:
  - harness-engineering
...
<Image
  src={harnessArch}
  alt="Architecture diagram showing how hooks, agents, and skills connect inside a .claude harness"
/>
...
<Image
  src={contextIsolation}
  alt="How subagents delegate work and return summaries without eating the main context window"
/>
...
<Image
  src={backpressureLoop}
  alt="The back pressure feedback loop: agent writes code, hook fires, validation passes or fails, error fed back as context"
/>
...
<Image
  src={sprintTimeline}
  alt="Gantt chart showing harness setup, entity scaffolding, custom features, QA, and deployment phases"
/>
...
<Image
  src={skillActivation}
  alt="Skill activation with forced-eval hook (100% reliable) versus without (coin-flip reliability)"
/>
...
<Image
  src={thymaBeforeAfter}
  alt="With Thyma the agent remembers across sessions. Without it, every session starts from zero."
/>
