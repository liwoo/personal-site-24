    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 rounded"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-card rounded-full text-primary-foreground hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
