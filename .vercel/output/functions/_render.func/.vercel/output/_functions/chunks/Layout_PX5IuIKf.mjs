import { a as createComponent, e as addAttribute, b as renderTemplate, l as defineScriptVars, c as createAstro, r as renderComponent, F as Fragment, u as unescapeHTML, s as spreadAttributes, d as renderSlot, n as renderHead } from './astro/server_Q924hkwF.mjs';
import 'kleur/colors';
/* empty css                           */
import { f as getAsset, U as UI, e as getCanonical, I as I18N, S as SITE, M as METADATA, h as ANALYTICS } from './permalinks_vW2eIjM2.mjs';
import 'clsx';
import merge from 'lodash.merge';
import { escape } from 'html-escaper';
import { a as adaptOpenGraphImages } from './images_Df5un7sY.mjs';
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(["<html", "", ' class="2xl:text-[20px]"> <head>', "", "", "", "", "", "", "", '<script type="application/ld+json">', "<\/script>", '</head> <body class="antialiased text-default bg-page tracking-tight"> ', " ", "  </body> </html>"])), addAttribute(language, "lang"), addAttribute(textDirection, "dir"), renderComponent($$result, "CommonMeta", $$CommonMeta, {}), renderComponent($$result, "Favicons", $$Favicons, {}), renderComponent($$result, "CustomStyles", $$CustomStyles, {}), renderComponent($$result, "ApplyColorMode", $$ApplyColorMode, {}), renderComponent($$result, "Metadata", $$Metadata, { ...metadata }), renderComponent($$result, "SiteVerification", $$SiteVerification, {}), renderComponent($$result, "Analytics", $$Analytics, {}), renderComponent($$result, "ViewTransitions", $$ViewTransitions, { "fallback": "swap" }), unescapeHTML(JSON.stringify({
    "@context": "https://schema.org",
    "@type": "Person",
    "name": "Jeremiah Chienda",
    "jobTitle": "AI Engineer",
    "description": "AI Engineer specializing in production agent systems, RAG pipelines, and LLM-powered applications for govtech and fintech.",
    "url": "https://chienda.com",
    "knowsAbout": [
    ...
    "sameAs": [
      "https://linkedin.com/in/jchienda",
      "https://github.com/liwoo",
      "https://twitter.com/liwucodes"
    ]
