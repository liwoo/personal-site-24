...
const metadata = {
	title: {
		"default": "Jeremiah Chienda",
		template: "%s — Jeremiah Chienda"
	},
	description: "Welcome to my Digital Garden. I'm Jeremiah Chienda, a software engineer and a writer. I write about software, productivity, and life.",
	robots: {
		index: true,
		follow: true
	},
