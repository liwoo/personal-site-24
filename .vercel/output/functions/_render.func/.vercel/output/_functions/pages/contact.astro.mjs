...
import 'kleur/colors';
import { $ as $$PageLayout } from '../chunks/PageLayout_5lr3B7GC.mjs';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { useState, useEffect, useRef, useCallback } from 'react';
import { ChevronLeft, ChevronRight } from 'lucide-react';
import { $ as $$Hero2 } from '../chunks/Hero2_CsZvk1oP.mjs';
...
const $$Contact = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": metadata }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Hero2", $$Hero2, {})} ${maybeRenderHead()}<div class="container w-full flex flex-col-reverse md:flex-row justify-end"> <div class="w-full lg:w-2/5 lg:-mt-18 z-10"> ${renderComponent($$result2, "ContactWithRecaptcha", ContactWithRecaptcha, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/liwu/Projects/websites/personal-24/src/components/widgets/ContactWithRecaptcha.tsx", "client:component-export": "default" })} </div> <div class="w-full lg:w-3/5"> ${renderComponent($$result2, "ResponsiveItemGrid", ResponsiveItemGrid, { "client:load": true, "columns": 2, "items": [
    {
      title: "Consulting",
      description: "I help companies of all sizes navigate complex Automation problems including Requirements Gathering, Software Development and more",
      icon: "tabler:briefcase"
    },
    {
      title: "Speaking",
      description: "I will speak at your organization or conference on a wide area of Engineering topics, including Blockchain, Fintech, AI and the African Tech Ecosystem at large",
      icon: "tabler:presentation"
    },
    {
      title: "Research",
      description: "I conduct high-quality Research to gain deeper insights on the technology issues you care about, using modern data-gathering, analysis and presentation techniques",
      icon: "tabler:test-pipe"
    },
    {
      title: "Training",
      description: "I have helped organizations imporove their teams' competencies on various Software Engineering topics, such as Continuous Integration, Automated Tested and more.",
      icon: "tabler:school"
    }
