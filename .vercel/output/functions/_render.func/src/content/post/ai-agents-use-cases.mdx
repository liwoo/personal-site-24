...
<Image src={agents} alt="Simplified version of a typical Business AI Workflow" />
...
<Image src={clients} alt="Sample AI-based Client Onboarding integrated in Teams" />
...
This can also translate to client identification and lead generation. And is an example of ambient agents: AI that works in the background and is not limited to your prompting it.

<Image src={leads} alt="Example UI of a Lead Generation Agent" />
